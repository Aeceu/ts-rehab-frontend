  ...
  return (
    <div className="w-full flex md:flex-row flex-col justify-between items-center px-[100px] py-8">
      <div className="flex flex-col sm:flex-row items-center text-[16px] gap-1 text-slate-600">
        @2024 <p className="text-[#25b953]">Rehabify.</p> All right reserved.
      </div>
      <div className="flex">
        <Link
        ...
        >
          <div className="opacity-70 cursor-pointer">
            <Image loading="lazy" src={fb} alt="fb" width={30} height={30} />
          </div>
        </Link>
        <Link
        ...
        >
          <div className="opacity-70 cursor-pointer">
            <Image loading="lazy" src={yt} alt="yt" width={30} height={30} />
          </div>
        </Link>
      </div>
    </div>
